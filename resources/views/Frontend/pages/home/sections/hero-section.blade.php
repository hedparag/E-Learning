    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('frontend/assets/images/slider/s-1.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('frontend/assets/images/slider/s-2.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('frontend/assets/images/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
