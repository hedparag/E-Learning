            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('teacher.profile.update') }}" method="POST" class="wsus__dashboard_profile_update" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="wsus__dashboard_profile wsus__dashboard_profile_avatar">
                                <div class="img">
                                    ...
                                    <label for="profile_photo">
                                        <img src="{{ asset('frontend/assets_edu/images/dash_camera.png') }}" alt="camera" class="img-fluid w-100">
                                    </label>
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('teacher.profile.update-password') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wsus__dashboard_profile_update_info">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('teacher.profile.update-social') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
