                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="{{ asset('admin_template/assets/img/logo.png') }}" class="img-fluid logo-desktop"
                                alt="logo" />
                            <img src="{{ asset('admin_template/assets/img/logo-icon.png') }}"
                                class="img-fluid logo-mobile" alt="logo" />
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav nav-right ml-auto">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/03.jpg') }}"
                                                                        alt="user3">
                                                                </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/01.jpg') }}"
                                                                        alt="user">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/02.jpg') }}"
                                                                        alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/04.jpg') }}"
                                                                        alt="user4">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/05.jpg') }}"
                                                                        alt="user5">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('admin_template/assets/img/avtar/06.jpg') }}"
                                                                        alt="user6">
                                                                </div>
                                                                <div class="notify-message">
                                ...
                                <li class="nav-item dropdown user-profile">
                                    <a href="javascript:void(0)" class="nav-link dropdown-toggle "
                                        ...
                                        aria-haspopup="true" aria-expanded="false">
                                        <img src="{{ asset('admin_template/assets/img/avtar/02.jpg') }}"
                                            alt="avtar-img">
                                        ...
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    ...
                                                    <small
                                                        class="text-white">{{ Auth::guard('admin')->user()->email }}</small>
                                                </div>
                                                <a href="javascript:;" class="text-white font-20 tooltip-wrapper"
                                                    data-toggle="tooltip" data-placement="top" title=""
                                                    data-original-title="Logout"> <i class="zmdi zmdi-power" onclick="$('.logoutForm').submit();"></i>
