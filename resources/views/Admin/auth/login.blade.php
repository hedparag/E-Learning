          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.login') }}">
              ...
              <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" placeholder="your@email.com" autocomplete="off":value="old('email')"required autofocus>
              </div>
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" class="form-control pass" name="password"  placeholder="Your password"  required autocomplete="current-password" >
