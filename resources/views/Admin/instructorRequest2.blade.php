...
<body>
    <script src="{{ asset('frontend/assets/dist/js/demo-theme.min.js?1692870487') }}"></script>
                        ...
                        <tbody>
                            @forelse ($data as $d)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.document-download', $d->id) }}"><svg
                                    ...
                                    <td>
                                        <form action="{{ route('admin.request-update', $d->id) }}" method="POST"
                                            class="status-{{ $d->id }}">
                                            @csrf
                                            <select name="status"
